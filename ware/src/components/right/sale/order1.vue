...
export default {
    data() {
        return {
            id : 1,
            form: [
                { id:1, orderType: 1, drugId: '',quantity: '',price: '', userPhone: this.$store.state.userPhone},
                { id:this.id++, orderType: 1, drugId: '',quantity: '',price: '', userPhone: this.$store.state.userPhone}
            ]
        }
    },
    created(){
